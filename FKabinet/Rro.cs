...
" + "<T3RXXXXG4S ROWNUM=\"1\">" + dataLine[3] + @"</T3RXXXXG4S>
" + "<T3RXXXXG5S ROWNUM=\"1\">" + dataLine[4] + @"</T3RXXXXG5S>
" + "<T3RXXXXG6S ROWNUM=\"1\">" + dataLine[5] + @"</T3RXXXXG6S>
" + "<T3RXXXXG7S ROWNUM=\"1\">" + dataLine[6] + @"</T3RXXXXG7S>
" + "<T3RXXXXG8S ROWNUM=\"1\" xsi:nil=\"true\"/>" + @"
" + "<T3RXXXXG9S ROWNUM=\"1\" xsi:nil=\"true\"/>" + @"
" + "<T3RXXXXG10S ROWNUM=\"1\" xsi:nil=\"true\"/>" + @"
" + "<T3RXXXXG11 ROWNUM=\"1\">" + dataLine[7] + @"</T3RXXXXG11>
" + "<T3RXXXXG12S ROWNUM=\"1\">" + dataLine[8] + @"</T3RXXXXG12S>
" + "<T3RXXXXG13 ROWNUM=\"1\">2657</T3RXXXXG13>" + @"
" + "<T3RXXXXG13S ROWNUM=\"1\">ГУ ДФС У М.КИЄВІ (СВЯТОШИНСЬКИЙ Р-Н М.КИЄВА)</T3RXXXXG13S>" + @"
<R0401G1>458</R0401G1>
<R0401G1S>" + dataLine[9] + @"</R0401G1S>
<R0402G1S>" + dataLine[10] + @"</R0402G1S>
<R0403G1>1088</R0403G1>
<R0403G1S>" + dataLine[11] + @"</R0403G1S>
<R0404G1S>" + dataLine[12] + @"</R0404G1S>
<R0405G1D>" + dataLine[13].ToString().Replace(".", "").Substring(0, 8) + @"</R0405G1D>
<R0408G1S>" + dataLine[14] + @"</R0408G1S>
...
";
                string ofname = kabinetPath + dataLine[0] + "_rro_" + dataLine[10] + ".xml";
        ...
        private static List<List<string>> GetRroData()
        {
            #region
            ...
            using (var context = new MyDataContext())
            {
                ...
                var lingVar = from dep in department
                              ...
                              new
                              {
                                  ...
                                  districtRegion = dep.DistrictRegionDep,
                                  city = dep.CityDep,
                                  ...
                                  dateManfacture = term.DateManufactureTerm,
                ...
                foreach (var line in lingVar)
                {
                    ...
                    lineList.Add(line.districtRegion);
                    ...
                    lineList.Add(line.dateManfacture);
